    ...
    <div className='w-screen h-screen bg-black flex items-center justify-center p-[3vh]'>
      ...
      <div className='relative w-full h-full'>
        ...
        <div className='absolute top-[40px] left-[40px] right-[40px] flex justify-between items-center z-40'>
          ...
          {/* Download Button */}
         <button>
          <Image src="/component/button.svg" width={100} height={100}/>
         </button>
        </div>
        ...
        <div className='absolute inset-0 flex items-center justify-center z-20'>
          <div className='relative mt-[-24vh]'>
            {/**<Image 
              ...
              priority
            />**/}
            <div className='bg-[#744DE0] w-[77vw] h-[52vh] flex flex-col'>
              <p className='text-white text-2xl lg:mt-[18px] text-center'>pick your café, choose your game</p>
              <span className='text-white lg:text-8xl font-bold text-center'>HASH FOR</span>
               <span className='text-white lg:text-8xl font-bold text-center'>GAMERS</span>
            </div>
          </div>
        </div>

        {/* Characters Standing Image - Positioned at bottom center */}
